...
const ReactWorks = () => {
    return(
        <>
            ...
            <ul>
                <li><span class="material-icons light-green-text text-accent-2 left">arrow_forward</span><a target="_blank" href="https://codepen.io/lenaryan/pen/QaywyG" rel="noopener noreferrer">Currency converter (Codepen)</a></li>
